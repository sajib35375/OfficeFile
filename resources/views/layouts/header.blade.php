       ...
       <div class="content_wrap">
          <div class="contact_logo">
             <div class="logo">
                ...
                <img src="{{ URL::to('') }}/admin/setting/{{ $general->logo }}" class="logo_main"
                     alt="" width="241" height="53">

{{--                <img src="{{ URL::to('') }}/uploads/general/{{ $user->photo }}" class="logo_fixed"--}}
{{--                     alt="" width="241" height="53">--}}
       ...
       <div class="sidebar_wrap sidebar">
          <div class="top_panel_controls">
             ...
             <div class="sidebar_pushy">
                 ...
                 <a href="{{ route('profile.view') }}">
                     <img style="width: 40px;height: 40px;border-radius: 50%;" src="{{ Auth::guard('admin')->user()->photo ? asset('uploads/general/'. Auth::guard('admin')->user()->photo ) : asset('images/index67.png') }}" class="logo_side" alt="" width="241" height="53"></a>
                 @else
