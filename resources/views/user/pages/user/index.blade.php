...
@section('main')
    ...
    @php
        $user_1 = \App\Models\User::find(\Illuminate\Support\Facades\Auth::id());
    @endphp
                               ...
                               <div class="sc_section_inner">
                                  <div class="sc_section_overlay">
                                     <div class="sc_section_content padding_on">
                                        <div class="sc_section_content_wrap">
                                            <img style="width:100%; height:300px;" src="{{ @$user_1 -> photo  ? asset('uploads/general/'.@$user_1->photo) : asset('images/index67.png') }}">
                                        </div>
                                     </div>
                                  </div>
                               </div>
                                            ...
                                            <div class="column-1_3 column_padding_bottom">
                                                <div id="sc_team_295_1" class="sc_team_item sc_team_item_1">
                                                   <div class="sc_team_item_avatar">
                                                      <img alt="" src="{{ @$user -> photo  ? url('uploads/general/'.@$user->photo) : url('images/index67.png') }}" style="height:200px; object-fit:cover;">
