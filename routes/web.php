...
Route::prefix('/admin')->middleware(['guest:admin','preventback'])->group(function(){
...
Route::prefix('/dashboard')->middleware(['admin'])->as('admin.')->group(function(){
    ...
    Route::prefix('user')->as('user.')->group(function(){
        ...
        Route::get('/edit/{id}' , [App\Http\Controllers\Admin\UserController::class , 'editUser'])->name('edit');
        Route::post('/update/{id}' , [App\Http\Controllers\Admin\UserController::class , 'updateUser'])->name('update');
